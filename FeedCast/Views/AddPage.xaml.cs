...
namespace FeedCast.Views
{
    public partial class AddPage : PhoneApplicationPage
    {
        ...
        {
            NavigationService.Navigate(new Uri("/Views/NewFeedPage.xaml", UriKind.Relative));
        }

        private void OnNewCategoryTap(object sender, System.Windows.Input.GestureEventArgs e)
        {
            NavigationService.Navigate(new Uri("/Views/NewCategoryPage.xaml", UriKind.Relative));
        }
    }
}